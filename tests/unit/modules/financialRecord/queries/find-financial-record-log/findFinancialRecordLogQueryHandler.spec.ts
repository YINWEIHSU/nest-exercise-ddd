import { FindFinancialRecordLogQueryHandler, FindFinancialRecordLogQuery } from '@modules/financialRecord/queries/find-financial-record-log/findFinancialRecordLogQueryHandler';
...
describe('FindFinancialRecordLogQueryHandler', () => {
    ...
    beforeEach(() => {
        ...
        handler = new FindFinancialRecordLogQueryHandler(mockDataSource as DataSource);
    });
    ...
    it('should return logs and reference maps', async () => {
        ...
        expect(result.references.applicationFormMap).toEqual({ 1: 'Name1', 2: 'Name2' });
        expect(result.references.counterpartyMap).toEqual({ 1: 'Name1', 2: 'Name2' });
